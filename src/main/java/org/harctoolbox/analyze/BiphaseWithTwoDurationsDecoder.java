...
public final class BiphaseWithTwoDurationsDecoder extends AbstractBiphaseDecoder {
    ...
    public BiphaseWithTwoDurationsDecoder(Analyzer analyzer, Analyzer.AnalyzerParams params) {
