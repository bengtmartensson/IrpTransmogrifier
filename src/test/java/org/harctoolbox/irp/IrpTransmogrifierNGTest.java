...
public class IrpTransmogrifierNGTest {
    ...
    public void testAnalyze3() {
        ...
        String result = IrpTransmogrifier.execute(args);
        assertEquals(result, "#0:\t{569,msb}<1,-1|1,-3>(16,-8,A:32,1,-44m){A=0x30441ce3}\tweight = 11\n"
                + "#1:\t{569,msb}<1,-1|1,-3>(16,-8,A:32,1,-39.756m){A=0xff00ff}\tweight = 11");
    }
    ...
    public void testAnalyze4() {
        ...
        String result = IrpTransmogrifier.execute(args);
        assertEquals(result, "{615,msb}<1,-1|2,-1>(4,-1,A:19,2,-12.596m)5{A=0x25c7}\tweight = 12");
    }
