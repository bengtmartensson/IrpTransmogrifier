...
public class IrpTransmogrifierNGTest {
     ...
     */
    @Test(enabled = true)
    public synchronized void testAnalyze1() {
        ...
        String result = IrpTransmogrifier.transmogrify(args);
     ...
     */
    @Test(enabled = true)
    public synchronized void testAnalyze2() {
    ...
    public void testListIrp() {
        ...
        String result = IrpTransmogrifier.transmogrify("list --irp nec1");
    ...
    public void testRenderSilly() {
        ...
        IrpTransmogrifier.ProgramExitStatus status = IrpTransmogrifier.main("render -p -i silly", System.out);
